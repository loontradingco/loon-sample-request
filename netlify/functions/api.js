  ...
  for (const producer of producers) {
    ...
    for (const wine of producerWines) {
      ...
      try {
        ...
        console.log(`Created line item: ${lineItemName}`);
      } catch (lineItemErr) {
    ...
    try {
      ...
      // Build reminder note for manual linking
      const manualLinkNote = `⚠️ MANUAL LINKING REQUIRED:\n• Customer: ${company}\n• Supplier: ${producer}`;
        ...
        children: [
          {
            ...
            type: 'callout',
            callout: {
              rich_text: [{ type: 'text', text: { content: manualLinkNote } }],
          ...
          },
          {
            ...
            type: 'paragraph',
            paragraph: {
              rich_text: [{ type: 'text', text: { content: `Created from online sample request form on ${new Date().toLocaleDateString()}` } }]
            }
          }
        ]
      });
