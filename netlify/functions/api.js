          ...
          if (companyName) {
            ...
            try {
              ...
              if (companySearch.results && companySearch.results.length > 0) {
                ...
                companyAddress = {
                  street: companyProps['Street']?.rich_text?.[0]?.plain_text || '',
                  city: companyProps['City']?.rich_text?.[0]?.plain_text || '',
                  state: companyProps['State / Province']?.multi_select?.[0]?.name || companyProps['State / Province']?.select?.name || '',
                  zip: companyProps['ZIP']?.rich_text?.[0]?.plain_text || '',
                  country: companyProps['Address Country']?.select?.name || 'United States'
                };
